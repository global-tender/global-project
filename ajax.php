...
{?>
	...
	if (isset($_POST['gp_name']) && isset($_POST['gp_email']) && isset($_POST['gp_message']))
	{
		...
		$headers = 'From: '.$from_user.' <no-reply@mg.global-tender.ru>' . "\r\n" .
		'Reply-To: no-reply@mg.global-tender.ru' . "\r\n" .
		'MIME-Version: 1.0' . "\r\n" .
		'Content-type: text/plain; charset=utf-8' . "\r\n" .
		'Return-Path: no-reply@mg.global-tender.ru.' . "\r\n";

		$params = "-fno-reply@mg.global-tender.ru";
