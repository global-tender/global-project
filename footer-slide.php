	...
	<div class="footer-main-text0" itemscope itemtype="http://schema.org/Organization">
		...
		<div class="footer-contact-details" >
			<p class="clean global-text contacts-text1">
				<i class="fa fa-phone fa-1x"></i><span>Тел.:&nbsp;&nbsp; <?if ($is_mobile) {?><a href="tel:+79913650615" itemprop="telephone">+7 991 365-06-15</a><?} else {?><span itemprop="telephone">+7 991 365-06-15</span><?}?> - Луковский Алексей</span><br />
			...
			<p class="clean global-text contacts-text2" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
				...
				<span itemprop="streetAddress">пер. Семашко, 21/60</span><br />
			</p>
		</div>

		<div>
			<a class="privacy-link" href="/privacy/" title="Политика конфиденциальности">Политика конфиденциальности</a>
		</div>
